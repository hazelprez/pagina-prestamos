  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      >
        ...
        <a
          ...
          href="info.php?id=<?php echo $_SESSION['id']?>"
        >
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <!-- Titulo -->
            <h1 class="h3 mb-4 text-gray-800">Historial de préstamos</h1>
                ...
                <div class="card shadow mb-4">
                  <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">
                      Se muestra una gráfica con el historial de prestamos de
                      cada empleado.
                    </h6>
                  </div>
                  <div class="card-body">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            Selecciona "Aceptar" si estas seguro de que deseas cerrar sesión
          </div>
    ...
    <script>
      ...
      const $grafica = document.querySelector("#grafica");
        ...
        const etiquetas = ides;
        //Valores
        const valores = prestamos;
