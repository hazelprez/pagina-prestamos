...
<head>
    ...
    <!--
        El ID del input de monto es: montoPrestamo
        El ID del input del número de quincenas: numeroQuincenas
        El ID del botón para solicitar el prestamo es: btnSolicitar
     -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Titulo -->
                    <h1 class="h3 mb-4 text-gray-800">Solicitar Préstamo</h1>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Datos necesarios para solicitar tu préstamo.</h6>
                                </div>
                                <div class="card-body">
                                <form action="php/solicitarPrestamo.php" method="get">
                                <div class="form-group" id="cajaPrestamo">
                                    ...
                                    <div class="form-group" id="cajaPrestamo">
                                        ...
                                        <input type="text" class="form-control form-control-user"
                                            id="montoPrestamo" name="montoPrestamo" placeholder="Monto del préstamo" required>
                                    </div>
                                    <div class="form-group" id="cajaQuincenas">
                                        <label>Número de quicenas:</label>
                                        <input type="number" class="form-control form-control-user"
                                            id="numeroQuincenas" name="numeroQuincenas" placeholder="Número de quincenas" required>
                                    </div>
                                    <button class="btn btn-primary btn-user btn-block" id="btnSolicitar">
                                        Solicitar
                                    </button>
                                    </form>
                                    <hr>
